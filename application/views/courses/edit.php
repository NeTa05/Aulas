<div id="edit" style="margin-top:5%;">
	...
	<?= form_open('courses/update',array('class'=>'form-horizontal' )); ?>
    ...
    <div class="control-group">
        ...
        <?= form_dropdown('id_career', $careers, $selected); ?>
        <!--                value, text   -->
    </div>
    ...
    <div id="go" class="form-actions">
      ...
      <?= anchor('courses/delete/'.$register->id,'Eliminar',array('class'=>'btn btn-warning','onClick'=>"return confirm('Va a borrar ¿Seguro?')"))?>
   </div>
