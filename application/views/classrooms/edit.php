<div id="edit" style="margin-top:5%;">
	...
	<?= form_open('classrooms/update',array('class'=>'form-horizontal' )); ?>
    ...
    <div class="control-group">
      ...
      <?= form_input(array('type'=>'text','name'=>'location','id'=>'location','value'=>$register->location));?>
    </div>
    ...
    <div id="go" class="form-actions">
      ...
      <?= anchor('classrooms/delete/'.$register->id,'Eliminar',array('class'=>'btn btn-warning','onClick'=>"return confirm('Va a borrar ¿Seguro?')"))?>
   </div>
