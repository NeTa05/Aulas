<div id="edit" style="margin-top:5%;">
	...
	<?= form_open('students/update',array('class'=>'form-horizontal' )); ?>
    ...
    <div id="go" class="form-actions">
      ...
      <?= anchor('students/delete/'.$register->id,'Eliminar',array('class'=>'btn btn-warning','onClick'=>"return confirm('Va a borrar ¿Seguro?')"))?>
   </div>
